...
if ( check_file('../code/BRIEF.py') and \
     check_file('../code/keypointDetect.py') and \
     check_file('../code/panoramas.py') and \
     check_file('../code/planarH.py') and \
     check_file('../results/6_1.npy') and \
     check_file('../results/testPattern.npy') and \
     check_file('../'+andrew_id+'_hw2.pdf') ):
